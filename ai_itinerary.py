...
configure(api_key="AIzaSyAtu1eYu6TgZOg-qvjcK_hg676mFVjSKfI")
...
def create_ui():
    ...
    root.configure(bg="#e6f7ff")  # Changed background color

    tk.Label(root, text="Enter City:", font=("Arial", 14, "bold"), bg="#e6f7ff", fg="#333").pack(pady=5)
    city_entry = tk.Entry(root, font=("Arial", 12), width=30)
    city_entry.pack(pady=5)

    tk.Label(root, text="Enter Number of Days:", font=("Arial", 14, "bold"), bg="#e6f7ff", fg="#333").pack(pady=5)
    days_entry = tk.Entry(root, font=("Arial", 12), width=30)
    days_entry.pack(pady=5)

    tk.Label(root, text="Enter Interests (comma separated):", font=("Arial", 14, "bold"), bg="#e6f7ff", fg="#333").pack(pady=5)
